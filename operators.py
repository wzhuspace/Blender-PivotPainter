    ...
    def execute(self, context):
        ...
        for nr, obj in enumerate(sorted_objects):
            ...
            if not obj.data.color_attributes:
                ...
                for this_attr in list(obj.data.color_attributes):
                    if not this_attr.name:
                        this_attr.name = "temp"
                    obj.data.color_attributes.remove(this_attr)
                obj.data.color_attributes.new(name='Col', type='FLOAT_COLOR', domain='CORNER')
        
            color_layer = obj.data.color_attributes["Col"]
